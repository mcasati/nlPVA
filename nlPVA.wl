...
Print["First version (2021). M. Casati, P. Lorenzoni, D. Valeri & R. Vitolo"];
...
CompatCheck[PFull_,QFull_,param_List]:=Module[{listJacobi={},dummyentr},For[i=1,i<=$d,i++,For[j=i,j<=$d,j++,For[k=j,k<=$d,k++,dummyentr=CompB[PFull,QFull,i,j,k,param];AppendTo[listJacobi,Simplify[dummyentr]];Print[dummyentr]]]];Return[listJacobi]];
